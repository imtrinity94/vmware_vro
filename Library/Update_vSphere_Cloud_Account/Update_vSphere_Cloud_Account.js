 ...
 * @return {VRA:CloudAccountVsphere} updatedVsphereCloudAccount
 */
...
updatedVsphereCloudAccount = client.updateVSphereCloudAccount(vSphereCloudAccount , body);
if(!updatedVsphereCloudAccount  || !(updatedVsphereCloudAccount.id || !updatedVsphereCloudAccount.name )){
    throw "vSphere Cloud Account Update operation failed. Please check the system logs for more details."
}
System.log("vSphere Cloud account " + updatedVsphereCloudAccount.name + " updated successfully!");

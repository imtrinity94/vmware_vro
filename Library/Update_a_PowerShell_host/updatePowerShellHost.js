/**
 * Updates the specified PowerShell Host from the plug-in's repository.
 *
 * @param {PowerShell:PowerShellHost} host - [object Object]
...
actionResult = System.getModule("com.vmware.library.powershell.configuration").updatePowerShellHost(host,name,type,hostName,transportProtocol,port,username,password,sessionMode,authentication,shellCodePage,idleTimeout, readTimeout) ;
/**
 * Disable vSAN customized swap object on cluster
 *
...
configSpec.extendedConfig.enableCustomizedSwapObject = false;

System.debug("Disabling vSAN customized swap object on cluster: " + cluster.name);

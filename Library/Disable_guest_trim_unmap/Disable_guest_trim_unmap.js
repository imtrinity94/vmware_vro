...
configSpec.unmapConfig = new VsanVsanUnmapConfig();
configSpec.unmapConfig.enable = false;

System.debug("Disabling guest trim unmap on cluster: " + cluster.name);

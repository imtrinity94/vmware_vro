...
qosRule = connection.createQoSRuleforSystem(priority,bwMinGoalKB,bwMaxLimitKB,ioMinGoal,ioMaxLimit,bwMinGoalOP,
...
if(qosRule!=null && qosRule!=undefined) {
	...
	System.log("QoS rule for system created successfully!");

/**
 * Set VUM baseline preference
 *
 * @param {VC:ClusterComputeResource} cluster
 * @param {string} vumBaselinePreference
 * @return {VC:Task} task
 */
...
configSpec.vumConfig = new VsanVsanVumConfig();
configSpec.vumConfig.baselinePreferenceType = vumBaselinePreference;

System.debug("Setting VUM baseline preference value [" + vumBaselinePreference + "] on cluster: " + cluster.name);

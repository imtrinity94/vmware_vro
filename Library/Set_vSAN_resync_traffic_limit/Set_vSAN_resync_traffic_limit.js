/**
 * Set vSAN resync traffic limit
 *
 * @param {VC:ClusterComputeResource} cluster
 * @param {number} resyncTrafficLimit
 * @return {VC:Task} task
 */
...
configSpec.resyncIopsLimitConfig = new VsanResyncIopsInfo();
configSpec.resyncIopsLimitConfig.resyncIops = resyncTrafficLimit;

System.debug("Setting vSAN resync traffic limit value [" + resyncTrafficLimit + "] on cluster: " + cluster.name);

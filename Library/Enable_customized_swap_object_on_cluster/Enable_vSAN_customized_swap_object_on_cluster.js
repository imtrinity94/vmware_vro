/**
 * Enable vSAN customized swap object on cluster
 *
...
configSpec.extendedConfig.enableCustomizedSwapObject = true;

System.debug("Enabling vSAN customized swap object on cluster: " + cluster.name);

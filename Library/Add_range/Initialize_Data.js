 ...
 * @param {boolean} assignMember
 * @param {string} member
 * @param {InfobloxIPAM:IpamMemberType} memberType
 ...
 * @return {string} attrMember
 * @return {InfobloxIPAM:IpamMemberType} attrMemberType
...
if (assignDhcpOptions && assignMember) {

 ...
 * @param {boolean} disable - [object Object]
 * @param {string} network - [object Object]
 * @param {number} cidr - [object Object]
 * @param {string} networkView - [object Object]
 * @param {string} member - [object Object]
 * @param {InfobloxIPAM:IpamMemberType} memberType - [object Object]
...
System.getModule("com.infoblox.ipam").addRange(ipamConnection,startAddress,endAddress,name,comment,disable,network,cidr,networkView,member,memberType,dhcpOptionDomainName,dhcpOptionDomainSearch,dhcpOptionDomainNameServers,dhcpOptionRouters,dhcpOptionNetbiosNameServers,ea1Definition,ea1Value,ea2Definition,ea2Value,ea3Definition,ea3Value,ea4Definition,ea4Value,ea5Definition,ea5Value,ea6Definition,ea6Value,ea7Definition,ea7Value,ea8Definition,ea8Value,ea9Definition,ea9Value,ea10Definition,ea10Value,restartIfNeeded) ;
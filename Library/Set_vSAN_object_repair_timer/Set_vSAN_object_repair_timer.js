/**
 * Set vSAN object repair timer
 *
 * @param {VC:ClusterComputeResource} cluster
 * @param {number} objectRepairTimer
 * @return {VC:Task} task
 */
...
configSpec.extendedConfig.objectRepairTimer = objectRepairTimer;

System.debug("Setting vSAN object repair timer value [" + objectRepairTimer + "] on cluster: " + cluster.name);

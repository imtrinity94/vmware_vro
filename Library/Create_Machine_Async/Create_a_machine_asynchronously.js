...
requestTracker = machineService.createMachineAsync(machineSpec);
System.log("Create machine request has been successfully placed with request tracking id " + requestTracker.id)

 ...
 * @param {VUM:TargetType} targetType
 ...
 * @return {VUM:Baseline} newBaseline
 */
...
if ('BOTH' == contentType.id || 'DYNAMIC' == contentType.id) {
    searchSpec = new VumPatchSearchSpec(serverURI);
...
newBaseline = VumObjectManager.createPatchBaseline(serverURI, name, description, contentType.id, targetType.id, includePatch, excludePatch, isExtension, searchSpec);
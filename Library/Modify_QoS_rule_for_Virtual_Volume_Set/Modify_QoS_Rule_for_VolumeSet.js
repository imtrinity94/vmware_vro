 ...
 */
qosRule = connection.modifyQoSRuleforVVSet(qosVvSetNme,priority,bwMinGoalKB,bwMaxLimitKB,ioMinGoal,ioMaxLimit,bwMinGoalOP,
...
if(qosRule!=null && qosRule!=undefined) {
	...
	System.log("QoS rule for Virtual Volume Set \""+ qosVvSetNme.name +"\"  modified successfully!");

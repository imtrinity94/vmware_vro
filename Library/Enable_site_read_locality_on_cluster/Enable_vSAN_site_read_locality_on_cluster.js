/**
 * Enable vSAN site read locality on cluster
 *
...
configSpec.extendedConfig.disableSiteReadLocality = false;

System.debug("Enabling vSAN site read locality on cluster: " + cluster.name);

/**
 * Disable vSAN site read locality on cluster
 *
...
configSpec.extendedConfig.disableSiteReadLocality = true;

System.debug("Disabling vSAN site read locality on cluster: " + cluster.name);

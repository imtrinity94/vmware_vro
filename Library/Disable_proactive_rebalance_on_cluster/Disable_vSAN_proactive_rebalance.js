/**
 * Disable vSAN proactive rebalance
 *
...
configSpec.extendedConfig.proactiveRebalanceInfo.enabled = false;

System.debug("Disabling vSAN proactive rebalance on cluster: " + cluster.name);

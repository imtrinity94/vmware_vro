/**
 * Disable vSAN performance service on cluster
 *
...
configSpec.perfsvcConfig.enabled = false;

System.debug("Disabling vSAN performance service on cluster: " + cluster.name);

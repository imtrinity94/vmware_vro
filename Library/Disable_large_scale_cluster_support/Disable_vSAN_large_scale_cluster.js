/**
 * Disable vSAN large scale cluster
 *
...
configSpec.extendedConfig.largeScaleClusterSupport = false;

System.debug("Disabling vSAN large scale cluster support on: " + cluster.name);

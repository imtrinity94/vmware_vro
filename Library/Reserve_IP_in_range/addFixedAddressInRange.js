/**
 * Adds fixed address using get next available IP address from specified network range.
 *
 ...
 * @param {string} msServerIpAddress
 * @return {string} actionResult
 */
//Auto generated script, cannot be modified !
actionResult = System.getModule("com.infoblox.ipam").addFixedAddressInRange(ipamConnection,startAddress,endAddress,networkView,macAddress,name,msServerIpAddress,comment,ea1Definition,ea1Value,ea2Definition,ea2Value,ea3Definition,ea3Value,ea4Definition,ea4Value,ea5Definition,ea5Value,ea6Definition,ea6Value,ea7Definition,ea7Value,ea8Definition,ea8Value,ea9Definition,ea9Value,ea10Definition,ea10Value,restartIfNeeded) ;